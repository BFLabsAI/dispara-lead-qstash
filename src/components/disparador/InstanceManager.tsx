...
const InstanceCard = ({ instance, index, loadInstances, openWebhook }) => {
  ...
  // Format name: remove '_', title case (first letter upper, rest lower per word)
      ...
      <div className="flex items-start justify-between mb-4 sm:mb-6">
        <div className="flex items-start space-x-3 sm:space-x-4 flex-1 min-w-0">
          <div className="flex-shrink-0 relative">
            ...
            <div className={`absolute -bottom-1 -right-1 sm:-bottom-2 sm:-right-2 status-indicator ${statusConfig.indicator} shadow-lg`}></div>
          </div>
