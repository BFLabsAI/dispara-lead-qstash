...
export const InstanceCard = ({ instance, index, loadInstances, openWebhook }: InstanceCardProps) => {
  ...
  return (
    <Card
      className="rounded-2xl border border-green-400 dark:border-green-700 shadow-sm animate-slide-in-up p-5 sm:p-6 transition-all hover:border-primary/50 hover:shadow-lg bg-green-100 dark:bg-green-800"
