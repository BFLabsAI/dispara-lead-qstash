...
import { BarChart3, Brain, MessageCircle, Calendar, Clock, MessageSquare, AlertCircle } from "lucide-react";
...
export const KPIs = ({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-7 gap-6 mb-6">
      <Card className="glass-card animate-slide-in-up">
        <CardContent className="p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="font-semibold text-lg">Envios (Sucesso)</h3>
          </div>
          <p className="text-4xl font-bold gradient-text">{totalEnvios.toLocaleString()}</p>
          <p className="text-sm font-medium text-primary/80">Entregues com sucesso</p>
        </CardContent>
      </Card>
      ...
      <Card className="glass-card animate-slide-in-up" style={{ animationDelay: '0.1s' }}>
        <CardContent className="p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="font-semibold text-lg">Falhas</h3>
          </div>
          <p className="text-4xl font-bold text-red-500">{failedCount.toLocaleString()}</p>
          <p className="text-sm font-medium text-red-500/80">Erros de envio</p>
        </CardContent>
      </Card>
      ...
      <Card className="glass-card animate-slide-in-up" style={{ animationDelay: '0.6s' }}>
        <CardContent className="p-6">
          <div className="flex items-center gap-4 mb-4">
