-- Migration: Optimize get_instance_contacts RPC with DISTINCT ON for latest message details
-- This version fetches sender_name from the latest message to improve display
